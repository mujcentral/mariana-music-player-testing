...
def spawn_lyrics_window(text_to_be_displayed, head_text, foot_text):
    ...
    head = tk.Label(root, text=head_text, font=("Segoe UI Bold", 14), fg="orange", bg="#1a1a1a")
    foot = tk.Label(root, text=foot_text, font=("Arial Italic", 10), fg='#ffadef', bg="#1a1a1a")
    ...
    text.config(state='disabled', font = ("Segoe UI", 11), fg="#ffdead", bg="#000000")
